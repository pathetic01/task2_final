...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        checkPossibilityOfTringle(triangleSideA,triangleSideB,triangleSideC);
    ...
    private static double calcArea(double triangleSideA, double triangleSideB, double triangleSideC, double p){
        ...
        radiusCalculated=S/p; // радиус треугольника с данными пользователем сторонами
        return(radiusCalculated);
    }

    private static void checkPossibilityOfTringle(double triangleSideA, double triangleSideB, double triangleSideC){
